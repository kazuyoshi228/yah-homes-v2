...
export const takasagoData: Record<Lang, TakasagoTranslations> = {
  ...
  ja: {
    ...
    checkin: {
      ...
      method: "スマートロックによる非対面のセルフチェックインです。ご到着の24時間前に解錠コードをお送りします。",
      idVerification: "チェックイン前に本人確認が必要です（パスポートまたは公的な身分証明書）。",
    },
    conditions: {
      title: "ご予約条件",
      minNights: "最低宿泊数：2泊",
      cancellation: "キャンセル：チェックイン7日前まで無料。それ以降は宿泊料金の50%を申し受けます。",
    ...
    faq: {
      ...
      items: [
        ...
        {
          q: "チェックインの流れを教えてください。",
          a: "スマートロックによる非対面のセルフチェックインです。ご到着の24時間前に解錠コードをお送りしますので、どなたとも顔を合わせずにご入室いただけます。",
        },
        {
        ...
        {
          q: "キャンセルポリシーを教えてください。",
          a: "チェックイン7日前までは無料でキャンセルいただけます。それ以降は宿泊料金の50%を申し受けます。",
        },
        {
          q: "足腰に不安があっても利用できますか？",
    ...
    propertyDescription: {
      ...
      highlights: [
        ...
        },
        {
          ...
          body: "大画面テレビと高音質サウンドシステムを備えたシアタールームがございます。ご家族やお仲間との映画鑑賞やだんらんに、ぜひご活用ください。",
        },
        {
