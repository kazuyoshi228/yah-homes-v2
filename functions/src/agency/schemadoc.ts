...
export const DOCUMENTED: Record<string, string[]> = {
  ...
  facts: [],
  finance: ["amount", "amountReported", "borrower", "conditionsUnknown", "entity", "firstPaymentMonth", "holder", "lender", "method", "months", "note", "principal", "rate", "ratio", "source"],
  fixedCosts: [],
  health: [],
  insurance: ["building", "pdf", "plan", "premiumPerYear", "product", "prop", "startDate", "status"],
  intake: ["at", "confidence", "data", "filename", "from", "gsPath", "hint", "instruction", "kind", "source", "status", "subject", "summary"],
  ...
  recurringCosts: ["acceptedAt", "acceptedBy", "place", "recurring", "source", "type", "unitPrice", "units"],
  renewalPlan: [],
